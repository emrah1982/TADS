...
namespace TADS.API.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RouteRolePermissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RoutePermissionId = table.Column<int>(type: "int", nullable: false),
                    RoleName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteRolePermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RouteRolePermissions_RoutePermissions_RoutePermissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemRolePermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemRolePermissions_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemRolePermissions_MenuItemId",
                table: "MenuItemRolePermissions",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteRolePermissions_RoutePermissionId",
                table: "RouteRolePermissions",
